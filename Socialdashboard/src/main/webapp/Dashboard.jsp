...
<title>Your Social Media Dashboard</title>
<style>
body {
...
<body>
	...
	<section id="feeds">
		<div class="feed-item">
			...
			<div class="feed-item">
				...
				<div class="feed-content">
					<p>
						<strong>Shradha</strong> posted a new video
					</p>
			...
			<div class="feed-content">
				<p>
					<strong>Mr Kedar Kapse</strong> posted a new photo
				</p>
				<p class="timestamp">
		...
		<div class="feed-item">
			...
			<div class="feed-content">
				<p>
					<strong>Akansha Lagad</strong> posted a new photo
				</p>
				<p class="timestamp">
		...
		<div class="feed-item">
			...
			<div class="feed-content">
				<p>
					<strong>Aman Kumar</strong> posted a new video
				</p>
		...
		<div class="feed-item">
			...
			<div class="feed-content">
				<p>
					<strong>Gunjan Waghmare</strong> posted a new photo
				</p>
				<p class="timestamp">
		...
		<div class="feed-item">
			...
			<div class="feed-content">
				<p>
					<strong>Abhishek Rana</strong> posted a new video
				</p>
		...
		<div class="feed-item">
			<iframe width="100%" height="315"
				src="https://www.youtube.com/embed/O9JluHklgkw" frameborder="0"
				allowfullscreen></iframe>
			<div class="feed-content">
				<p>
					<strong>India Today</strong> posted a new video
				</p>
				<p class="timestamp">Iran Pakistan Attack News Live: Pakistan
					Military Attacks Iran | India Today Live</p>
				<div class="actions">
		...
		<div class="feed-item">
			...
			<div class="feed-content">
				<p>
					<strong>Ashutosh </strong> posted a new photo
				</p>
				<p class="timestamp">
	...
	<script>
		...
		function likePost(feedId) {
		    var likeButton = document.querySelector("#comments-" + feedId + " button:nth-child(1)");
		    likeButton.classList.toggle("liked");
		}

		function likePost(feedId) {
		    var likeButton = document.querySelector("#comments-" + feedId + " button:nth-child(1)");
		    var likeCountElement = document.querySelector("#comments-" + feedId + " .like-count");
